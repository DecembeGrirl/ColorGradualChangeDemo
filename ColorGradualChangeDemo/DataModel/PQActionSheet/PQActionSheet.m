...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if(section == 0 && self.titleText) {
        ...
        [label setTextColor:[UIColor colorWithRed:34 green:34 blue:34 alpha:1.0]];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(!cell) {
        ...
        [cell setBackgroundColor:[UIColor colorWithRed:215.0f green:215.0f blue:215.0f alpha:1.0f]];
...
//        [cell addSubview:sepLine];
    ...
    [cell.textLabel setTextColor:[UIColor colorWithRed:34.0f green:34.0f blue:34.0f alpha:1.0f]];
